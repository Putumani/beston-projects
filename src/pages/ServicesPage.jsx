...
import { 
  FaHammer, FaWrench, FaShieldHalved, FaHouse, FaPaintRoller, 
  FaDroplet, FaBorderAll, FaLayerGroup, FaSliders, FaFire, FaCircleCheck 
...
import staircaseImg from '../assets/services-page/structural-crack-repairs-5.jpg';
import campsBayRoofingImg from '../assets/services-page/camps-bay-roofing.jpg';
import tilingImg from '../assets/services-page/tiling.jpg';
...
const servicesList = [
  {
    ...
    features: ["New boundary wall construction", "Pillar extensions and decorative pillars", "Professional plastering services"],
    icon: FaHammer,
  ...
  },
  {
    ...
    features: ["Site excavations and land clearing", "Concrete casting and pouring", "Slab floor casting for buildings"],
    icon: FaWrench,
  ...
  },
  {
    ...
    features: ["Structural crack repairs", "House extensions and additions", "Wall openings and modifications"],
    icon: FaShieldHalved,
    image: staircaseImg
  },
  {
    ...
    features: ["Roofing installations (all types)", "Complete roof replacement", "Torch-on waterproofing for parapets"],
    icon: FaHouse,
  ...
  },
  {
    ...
    features: ["Exterior painting (Bothasig area specialist)", "Boundary wall painting", "Parapet painting"],
    icon: FaPaintRoller,
  ...
  },
  {
    ...
    features: ["Tiling around swimming pools", "Patio and outdoor area tiling", "Boundary wall capping tiling"],
    icon: FaDroplet,
    image: tilingImg
  },
  {
    ...
    features: ["Paving from R120/m²", "Driveway paving", "Walkway and pathway paving"],
    icon: FaBorderAll,
    image: pavingImg
  },
  {
    ...
    features: ["House extensions and additions", "Home alterations and renovations", "Garage conversions"],
    icon: FaLayerGroup,
    image: houseImg
  },
  {
    ...
    features: ["Wooden to aluminium window replacement", "Door installation and replacement", "Sliding doors"],
    icon: FaSliders,
  ...
  },
  {
    ...
    features: ["Built-in braai (outdoor)", "Boundary wall renovations", "Outdoor kitchen installation"],
    icon: FaFire,
    image: braaiImg
  }
];
...
export default function ServicesPage({ navigateTo }) {
  ...
  return (
    <div className="w-full bg-[#f9fafb] min-h-screen pb-16 font-sans">
      <div className="w-full text-white flex flex-col justify-center px-6 md:px-12 relative overflow-hidden" style={{ backgroundColor: brandDark, minHeight: '260px' }}>
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#fff_1px,transparent_1px)] [background-size:16px_16px]"></div>
        <div className="w-full mx-auto relative z-10" style={{ maxWidth: '1200px' }}>
          <span className="text-xs uppercase font-extrabold tracking-widest text-slate-300 bg-white/10 px-3 py-1 rounded-full">Our Portfolio Scope</span>
          <h1 className="text-3xl md:text-5xl font-black tracking-tight mt-3">Our Exterior Construction Services</h1>
      ...
      <main className="w-full mx-auto px-4 md:px-8 mt-12" style={{ maxWidth: '1200px' }}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesList.map((service, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col overflow-hidden transition-all duration-300">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 mb-2">{service.title}</h3>
                  <p className="text-gray-600 text-sm leading-relaxed mb-5 font-medium">{service.description}</p>
        ...
        <div className="w-full border border-gray-100 rounded-3xl p-8 md:p-12 text-center mt-16 bg-white shadow-sm">
          <h2 className="text-2xl md:text-3xl font-black tracking-tight" style={{ color: brandDark }}>Need a Custom Solution?</h2>

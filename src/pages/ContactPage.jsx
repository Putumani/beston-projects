...
export default function ContactPage() {
  ...
  return (
    <div className="w-full bg-[#f9fafb] py-16 px-4 md:px-8 font-sans">
      <div className="w-full mx-auto" style={{ maxWidth: '900px' }}>
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 font-medium">Ready to start your next project? Let's discuss your requirements.</p>
        </div>

...
export default function PavingGallery({ navigateTo, brandDark, brandOrange }) {
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 md:px-8 mt-8">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-orange-50 px-4 py-1.5 rounded-full mb-4">
            ...
            <span className="text-xs font-black uppercase tracking-wider" style={{ color: brandOrange }}>Portfolio Showcase</span>
          </div>
          <h2 className="text-2xl font-black tracking-tight text-gray-900">
            Paving Portfolio
          </h2>
          <p className="text-gray-500 mt-2 max-w-lg mx-auto">
            Browse our premium paving installations across residential and commercial properties
          </p>
        </div>
